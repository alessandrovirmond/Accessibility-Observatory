...
class _DateState extends State<Date> {
  ...
  getDate() async {
    try {
      ...
      setState(() {
        date = fetchedDate;
        isLoading =
            false; // Atualiza o estado para indicar que os dados foram carregados
      });
    } catch (e) {
      setState(() {
        isLoading =
            false; // Mesmo que ocorra um erro, devemos parar o carregamento
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Text( "Última atualização: " + formatToBrazilianDate(date),
